...
<body>
		...
		%>
	<form action="alterCarComando.jsp?id=<%out.print(id);%>" method="POST">
		...
		<div class="container">
			<div class="card">
				<div class="card-header text-center">
						<div class='h2' style="position: relative;"><span class='' style="position:absolute; left:0"><a href='adminPage.jsp'><i class="fas fa-arrow-circle-left"></i></a></span> <span class=''>Alterar Carro </span><i class="fas fa-car-alt"></i></div>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-lg-6 md-6 sm-6 text-center">
							<label for=""><strong>Nome do Carro</strong></label>
							<input type="text" style="text-align: center" value="<% out.print(nome); %>" class="form-control" name="nomeCarro">
						</div>
						<div class="col-lg-6 md-6 sm-6 text-center">
								<label for=""><strong>Marca do Carro</strong></label>
								<input type="text" style="text-align: center" value="<% out.print(marca); %>" class="form-control" name="marcaCarro">
						</div>
					</div>
					<div class="row mt-2">
							<div class="col-lg-6 md-6 sm-6 text-center">
								<label for=""><strong>Preço do Carro</strong></label>
								<input type="text" style="text-align: center" value="<% out.print(preco); %>" class="form-control" name="precoCarro">
							</div>
							<div class="col-lg-6 md-6 sm-6 text-center">
									<label for=""><strong>País de Origem do Carro</strong></label>
									<input type="text" style="text-align: center" value="<% out.print(origem); %>" class="form-control" name="origemCarro">
							</div>
					</div>
					<div class="row mt-2">
							<div class="col-lg-12 md-12 sm-12 text-center">
								<label for=""><strong>Descrição do Carro</strong></label>
								<input class="form-control" style=" width: 100%;" value="<% out.print(desc); %>"  name="descCarro">
							</div>
							
					</div>
					<div class="row mt-2">
							<div class="col-lg-12 md-12 sm-12 text-center">
								<label for=""><strong>Imagem Padrão(Nome do Arquivo)</strong></label>
								<input class="form-control" style=" width: 100%;" value="<% out.print(img); %>"  name="imgDefaul">
							</div>
				...
				<div class="card-footer text-right">
					<a href='listCars.jsp' class='btn btn-warning'>Voltar <i class="fas fa-undo"></i></a>
					<button type="reset" class='btn btn-danger'>Resetar Valores <i class="fas fa-broom"></i></button>
					<button type="submit" class='btn btn-info'>Alterar <i class="far fa-paper-plane"></i></button>
				</div>
			</div>
		</div>
	</form>	
